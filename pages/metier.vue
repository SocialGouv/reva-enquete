  ...
  <div class="bg-yellow-100 relative">
    ...
    <section class="px-4 flex justify-center bg-yellow-100 transition-all transform" v-bind:class="[displayEnqueteInterne ? 'absolute sm:relative bottom-0 sm:-translate-y-80' : 'hidden translate-y-0']">
      <div class="w-full max-w-xl mx-auto pt-8">
        <div class="pb-5">
          <p class="mt-2 max-w-4xl text-xl text-gray-800">Selon vous, la question ci-dessus permet de savoir qu'il existe bien une relation entre votre ou vos métiers et le diplôme ciblé</p>
        </div>
        ...
        <div class="md:flex md:items-center md:justify-between py-12">
          <div class="flex-1 min-w-0">
            <!-- <button @click="previousPage" type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Question précédente
            </button> -->
          </div>
          <div class="mt-4 flex md:mt-0 md:ml-4">
            <nuxt-link to="experiences" type="button" class="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-700 hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Question suivante
            </nuxt-link>
          </div>
        </div>
