<template>
  <div class="bg-yellow-100 relative">
      ...
      <div class="w-full max-w-xl mx-auto pb-24 pt-6">
        ...
        <div class="pb-5">
          <h3 class="text-2xl leading-10 font-medium text-gray-900">
            Je suis disponible dans les 3 prochains mois
          </h3>
          <p class="mt-2 max-w-4xl text-sm text-gray-500">On constate généralement qu'il faut accorder 5 heures par semaine pour une VAE</p>
        </div>
    ...
    <section class="px-4 flex justify-center bg-yellow-100 transition-all transform" v-bind:class="[displayEnqueteInterne ? 'absolute sm:relative bottom-0 sm:-translate-y-80' : 'hidden translate-y-0']">
      <div class="w-full max-w-xl mx-auto pt-8">
        <div class="pb-5">
          <p class="mt-2 max-w-4xl text-xl text-gray-800">
            Selon vous, la question ci-dessus permet d'estimer votre disponibilité pour votre démarche VAE
          </p>
        </div>
        ...
        <fieldset class="mt-2">
          ...
          <div class="bg-white rounded-md -space-y-px">
              ...
              <label @click="minus" class="rounded-tl-md rounded-tr-md relative border p-4 flex cursor-pointer focus:outline-none">
                ...
                <div class="ml-3 flex flex-col">
                  <!-- Checked: "text-indigo-900", Not Checked: "text-gray-900" -->
                  <span id="enquete-interne-4-label" class="block text-sm font-medium">
                    Complètement d'accord
                  </span>
                </div>
              </label>
              ...
              <label @click="minus" class="relative border p-4 flex cursor-pointer focus:outline-none">
                ...
                <div class="ml-3 flex flex-col">
                  <!-- Checked: "text-indigo-900", Not Checked: "text-gray-900" -->
                  <span id="enquete-interne-3-label" class="block text-sm font-medium">
                    Plutôt d'accord
                  </span>
                </div>
              </label>
              ...
              <label @click="more" class="relative border p-4 flex cursor-pointer focus:outline-none">
                ...
                <div class="ml-3 flex flex-col">
                  <!-- Checked: "text-indigo-900", Not Checked: "text-gray-900" -->
                  <span id="enquete-interne-2-label" class="block text-sm font-medium">
                    Ni d'accord, ni pas d'accord
                  </span>
                </div>
              </label>
              ...
              <label @click="more" class="relative border p-4 flex cursor-pointer focus:outline-none">
                ...
                <div class="ml-3 flex flex-col">
                  <!-- Checked: "text-indigo-900", Not Checked: "text-gray-900" -->
                  <span id="enquete-interne-1-label" class="block text-sm font-medium">
                    Pas d'accord
                  </span>
                </div>
              </label>
              ...
              <label @click="more" class="rounded-bl-md rounded-br-md relative border p-4 flex cursor-pointer focus:outline-none">
                ...
                <div class="ml-3 flex flex-col">
                  <!-- Checked: "text-indigo-900", Not Checked: "text-gray-900" -->
                  <span id="enquete-interne-0-label" class="block text-sm font-medium">
                    Pas du tout d'accord
                  </span>
                </div>
              </label>
        ...
        <div class="md:flex md:items-center md:justify-between py-12">
          <div class="flex-1 min-w-0">
            <nuxt-link to="confiance_obtention" type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Question précédente
            </nuxt-link>
          </div>
          <div class="mt-4 flex md:mt-0 md:ml-4">
            <nuxt-link to="numerique" type="button" class="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-700 hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Question suivante
            </nuxt-link>
          </div>
        </div>
