      ...
      <div class="w-full max-w-xl mx-auto pb-24 pt-6">
        ...
        <div class="pb-5">
          <h3 class="text-2xl leading-10 font-medium text-gray-900">
            Je suis à l'aise avec les outils numériques
          </h3>
          <p class="mt-2 max-w-4xl text-sm text-gray-500">Internet, mobile, ordinateur, etc</p>
        </div>
      ...
      <div class="w-full max-w-xl mx-auto pt-8">
        ...
        <div class="md:flex md:items-center md:justify-between py-12">
          ...
          <div class="mt-4 flex md:mt-0 md:ml-4">
            <nuxt-link to="objectifs" type="button" class="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-700 hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Question suivante
            </nuxt-link>
          </div>
        </div>
